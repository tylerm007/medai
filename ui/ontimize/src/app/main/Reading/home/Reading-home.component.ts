...
@Component({
  selector: 'Reading-home',
  templateUrl: './Reading-home.component.html',
  styleUrls: ['./Reading-home.component.scss']
})
export class ReadingHomeComponent implements AfterViewInit {
