...
@Component({
  selector: 'Contraindication-home',
  templateUrl: './Contraindication-home.component.html',
  styleUrls: ['./Contraindication-home.component.scss']
})
export class ContraindicationHomeComponent implements AfterViewInit {
