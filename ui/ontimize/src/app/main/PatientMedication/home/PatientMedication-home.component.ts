...
@Component({
  selector: 'PatientMedication-home',
  templateUrl: './PatientMedication-home.component.html',
  styleUrls: ['./PatientMedication-home.component.scss']
})
export class PatientMedicationHomeComponent implements AfterViewInit {
