...
@Component({
  selector: 'PatientLab-home',
  templateUrl: './PatientLab-home.component.html',
  styleUrls: ['./PatientLab-home.component.scss']
})
export class PatientLabHomeComponent implements AfterViewInit {
