...
@Component({
  selector: 'InsulinRule-home',
  templateUrl: './InsulinRule-home.component.html',
  styleUrls: ['./InsulinRule-home.component.scss']
})
export class InsulinRuleHomeComponent implements AfterViewInit {
