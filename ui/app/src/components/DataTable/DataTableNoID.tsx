...
export function DataTableNoID<T>({
    columns,
    data = [],
    totalCount,
    sortConfig,
                        ...
                        <tr>
                            {columns.map((column) => (
                                <th
                                    ...
                                    className={`px-6 py-3 text-xs font-medium text-gray-500 dark:bg-gray-600 dark:text-white uppercase tracking-wider ${column.align === "right"
                                            ? "text-right"
                                            : column.align === "center"
                                                ? "text-center"
                                                : "text-left"
            ...
            <div className="flex items-center justify-between py-4 border-t border-gray-200">
                ...
                <div className="flex space-x-2">
                    <button
                        ...
                        className={`px-3 py-1.5 border dark:text-white rounded-md text-sm ${isFirstPage
                    ...
                    <button
                        disabled={isLastPage}
                        onClick={() => onPageChange(currentPage + 1)}
                        className={`px-3 py-1.5 border dark:text-white rounded-md text-sm ${isLastPage
                                ? "opacity-50 cursor-not-allowed"
                                : "hover:bg-gray-50 dark:hover:bg-gray-600"
                            }`}
                    >
