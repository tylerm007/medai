...
@Component({
  selector: 'Dosage-home',
  templateUrl: './Dosage-home.component.html',
  styleUrls: ['./Dosage-home.component.scss']
})
export class DosageHomeComponent implements AfterViewInit {
