...
@Component({
  selector: 'ReadingHistory-home',
  templateUrl: './ReadingHistory-home.component.html',
  styleUrls: ['./ReadingHistory-home.component.scss']
})
export class ReadingHistoryHomeComponent implements AfterViewInit {
