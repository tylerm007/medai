...
@Component({
  selector: 'DrugUnit-home',
  templateUrl: './DrugUnit-home.component.html',
  styleUrls: ['./DrugUnit-home.component.scss']
})
export class DrugUnitHomeComponent implements AfterViewInit {
